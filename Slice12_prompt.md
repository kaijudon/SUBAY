...
## Approach
Thin slice — a curated-list three-tier rollup. Build the per-locus denominators
and the duty-to-disclose intersection test-first (established+failure → flag;
established-only → no flag). Wire export after.
