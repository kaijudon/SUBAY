...
from subay.registry.admin import (
...
def test_admin_site_is_otp_enforced_and_branded():
    ...
    assert isinstance(admin.site, SubayAdminSite)
    assert admin.site.site_header == "SUBAY"
...
def test_biobank_and_genotyping_autocomplete_and_target_search_fields():
    from subay.registry.models import GenotypeCall, GenotypingResult, PipelineRun
