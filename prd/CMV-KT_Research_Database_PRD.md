...
- Name **SUBAY** (Surveillance & Unified Bioarchive for Antiviral nephrologY); Django package `subay`; the login page header reads "SUBAY". Use it consistently across PRD, issues, IRB/DPO registration, and `INSTALLED_APPS`.
