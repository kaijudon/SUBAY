...
The completer-cohort accounting that makes the D1-plus-replacement analytic cohort and the CONSORT diagram reproducible from data. An Analyst can rebuild the cohort flow without a hand-kept spreadsheet, and a lab error never wrongly evicts a cooperative patient.
