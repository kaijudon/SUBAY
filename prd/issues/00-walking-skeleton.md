# Slice 00 — SUBAY: Walking skeleton & deploy spine
...
- [ ] Roles `data_manager`, `reviewing_clinician`, `data_analyst`, `admin` exist as Django Groups; login requires TOTP 2FA; admin/login header reads "SUBAY".
